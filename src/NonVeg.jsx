...
import './Veg.css'; // using same styles as Veg
...
function NonVeg() {
  ...
  const currentItems = filteredNonVegProducts.slice(indexOfFirstItem, indexOfLastItem);
  const totalPage = Math.ceil(filteredNonVegProducts.length / itemsPerPage);
      ...
      <div className="row">
        ...
        <div className="col-md-9">
          <div className="veg-list">
            {filteredNonVegProducts.length > 0 ? (
              ...
              <p>No Non-Veg Products Available</p>
            )}
          </div>

          {/* ✅ Pagination Controls */}
          <div className="mt-4 pagination-left">
